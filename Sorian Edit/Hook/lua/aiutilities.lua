...
function SetupCheat(aiBrain, cheatBool)
    if cheatBool then
        ...
        buffAffects.EnergyProduction.Mult = tonumber(ScenarioInfo.Options.CheatMult) * 1.7
        buffAffects.MassProduction.Mult = tonumber(ScenarioInfo.Options.CheatMult) * 1.3
