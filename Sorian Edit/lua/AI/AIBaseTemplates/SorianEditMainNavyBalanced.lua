...
BaseBuilderTemplate {
    BaseTemplateName = 'SorianEditMainNavyBalanced',
    Builders = {
        -- ==== ECONOMY ==== --
        -- Factory upgrades
    ...
    FirstBaseFunction = function(aiBrain)
        ...
        if personality == 'sorianeditnavycheat' or personality == 'sorianeditnavy' then
            LOG('------ M-FirstBaseFunction Main Navy Balanced '..personality)
