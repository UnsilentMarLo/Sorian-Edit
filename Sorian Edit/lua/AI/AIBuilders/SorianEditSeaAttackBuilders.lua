...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconEfficiencyCombined', { 0.8, 0.9 }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			-- { EBC, 'GreaterThanEconStorageRatio', { 0.1, 0.3 } },
			{ EBC, 'GreaterThanEconEfficiencyCombined', { 0.8, 0.9 }},
            -- { UCBC, 'HaveForEach', { categories.NAVAL * categories.MOBILE * categories.TECH2, 0.35, categories.NAVAL * categories.MOBILE * categories.TECH3 }},
        },
    },
    Builder {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            -- { EBC, 'GreaterThanEconStorageRatio', { 0.1, 0.3 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconEfficiencyCombined', { 1.0, 1.0 }}, -- { 0.85, 0.8 }},
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ MIBC, 'FactionIndex', {1}},
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
            -- { UCBC, 'HaveForEach', { categories.NAVAL * categories.MOBILE * categories.TECH2, 0.35, categories.NAVAL * categories.MOBILE * categories.TECH3 * categories.OVERLAYANTINAVY }},
        },
    },
    Builder {
        BuilderName = 'SorianEdit T3Cruiser alt modded',
        PlatoonTemplate = 'T3Battlecruiser',
        Priority = 3200,
        PriorityFunction = WaterPrio,
        BuilderType = 'Sea',
        BuilderConditions = {
			{ WaterRatioCondition, { 3 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ UCBC, 'CanBuildCategorySE', { categories.NAVAL * categories.MOBILE * categories.TECH3 * categories.CRUISER} },
            -- { UCBC, 'HaveForEach', { categories.NAVAL * categories.MOBILE * categories.TECH2, 0.35, categories.NAVAL * categories.MOBILE * categories.TECH3 * categories.OVERLAYANTINAVY }},
        },
    },
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveForEach', { categories.NAVAL * categories.MOBILE * categories.TECH3, 2.5, categories.NAVAL * categories.MOBILE * categories.TECH3 * categories.SUBMERSIBLE - categories.SILO }},
        },
    },
}
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'PoolLessAtLocation', { 'LocationType', 3, 'MOBILE TECH2 NAVAL' } },
        },
    },
    Builder {
