...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 1.0, 1.0 }}, -- { 0.40, 0.6 }},
            { UCBC, 'UnitsGreaterAtEnemy', { 0 , categories.NAVAL } },
            { UCBC, 'HaveForEach', { categories.NAVAL * categories.TECH1 * categories.SUBMERSIBLE, 2, categories.NAVAL * categories.TECH1 * categories.FRIGATE}},
            { UCBC, 'HaveForEach', { categories.LAND, 0.5, categories.NAVAL}},
        },
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveForEach', { categories.NAVAL * categories.MOBILE * categories.DIRECTFIRE - categories.TECH1 - categories.SHIELD, 0.25, categories.NAVAL * categories.TECH2 * categories.MOBILE * categories.SHIELD }},
            { UCBC, 'HaveForEach', { categories.LAND, 0.5, categories.NAVAL}},
        },
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconStorageRatio', { 0.1, 0.3 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 1.0, 1.0 }}, -- { 0.40, 0.6 }},
            { UCBC, 'HaveForEach', { categories.NAVAL * categories.MOBILE * categories.DIRECTFIRE - categories.TECH1 - categories.CRUISER, 0.45, categories.NAVAL * categories.TECH2 * categories.MOBILE * categories.CRUISER }},
            { UCBC, 'HaveForEach', { categories.LAND, 0.5, categories.NAVAL}},
        },
        BuilderType = 'Sea',
    },
