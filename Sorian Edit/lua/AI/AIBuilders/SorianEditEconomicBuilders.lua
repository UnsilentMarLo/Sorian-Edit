...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 90 } },
    ...
    Builder {
        ...
        BuilderConditions = {
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 260 } },
            { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, categories.ENGINEER } },
            { UCBC, 'PoolLessAtLocation', { 'LocationType', 1, categories.MOBILE * categories.TECH1 * categories.ENGINEER } },
            { UCBC, 'UnitCapCheckLess', { .6 } },
        },
...
BuilderGroup {
    BuilderGroupName = 'SorianEdit Initial Air ACU Builders',
    BuildersType = 'EngineerBuilder',

    -- Initial builder
    Builder {
        BuilderName = 'SorianEdit CDR Air Initial Balanced',
        -- PlatoonAddBehaviors = { 'CommanderBehaviorSorian', },
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 20000000,
        BuilderConditions = {
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 4100000,
        BuilderConditions = {
			{ UCBC, 'LessThanGameTimeSecondsSE', { 150 } },
    ...
    Builder {
        ...
        Priority = 1000000,
        BuilderConditions = {
				{ UCBC, 'LessThanGameTimeSecondsSE', { 120 } },
    ...
    Builder {
        ...
        Priority = 400000,
        BuilderConditions = {
			{ UCBC, 'LessThanGameTimeSecondsSE', { 250 } },
			{ UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.ENERGYPRODUCTION * categories.TECH1 } },
        },
        BuilderType = 'Any',
        BuilderData = {
    ...
    Builder {
        ...
        BuilderConditions = {
			{ UCBC, 'UnitCapCheckLess', { .6 } },
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 60 }},
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 400 }},
    ...
    Builder {
        ...
        Priority = 21000,
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsInCategoryBeingBuiltAtLocationSE', { 'LocationType', 0, categories.STRUCTURE * categories.HYDROCARBON }},
...
BuilderGroup {
    BuilderGroupName = 'SorianEditAirACUBuilders',
    BuildersType = 'EngineerBuilder',
	
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Power - Init',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 4100000,
        BuilderConditions = {
			{ UCBC, 'LessThanGameTimeSecondsSE', { 150 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR Base Mex Init',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 4000000,
        BuilderConditions = {
				{ UCBC, 'LessThanGameTimeSecondsSE', { 150 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Power - Init 2nd',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 2000000,
        BuilderConditions = {
			{ UCBC, 'LessThanGameTimeSecondsSE', { 150 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR Base Mex 2nd',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 1000000,
        BuilderConditions = {
				{ UCBC, 'LessThanGameTimeSecondsSE', { 120 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR Base Mex 2+ After Hydro',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 555000,
        BuilderConditions = {
				{ UCBC, 'LessThanGameTimeSecondsSE', { 140 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Air - Init 2nd',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 390000,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.23, 0.3 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Air - Init 2nd aHydro',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 389900,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.22, 0.34 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Land - Init 4',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 380000,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.25, 0.3 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Land if Path - Init aHydro',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 380000,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.25, 0.3 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Land if Path  - Init',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 380000,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.25, 0.3 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air T1 Factory ACU - Overbuild',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 1200,
        BuilderConditions = {
			{ UCBC, 'UnitCapCheckLess', { .6 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Air CDR T1 Power - additional',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 3500,
        BuilderConditions = {
            { EBC, 'LessThanEconStorageRatio', { 1.0, 0.2 } },
    ...
    -- CDR Assisting
    Builder {
        BuilderName = 'SorianEdit Air CDR Assist Hydrocarbon',
        PlatoonTemplate = 'CommanderAssist',
        Priority = 21000,
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsInCategoryBeingBuiltAtLocationSE', { 'LocationType', 0, categories.STRUCTURE * categories.HYDROCARBON }},
    ...
    -- CDR Assisting
    Builder {
        BuilderName = 'SorianEdit Air CDR Assist T4',
        PlatoonTemplate = 'CommanderAssistSorianEdit',
        Priority = 750,
        BuilderConditions = {
			{ UCBC, 'LocationEngineersBuildingAssistanceGreater', { 'LocationType', 0, 'EXPERIMENTAL' }},
    ...
    Builder {
       BuilderName = 'SorianEdit Air CDR Assist Factory Upgrade Tech 2',
       PlatoonTemplate = 'CommanderAssistSorianEdit',
       Priority = 6000,
       BuilderConditions = {
			{ EBC, 'GreaterThanEconStorageRatio', { 0.2, 0.6 } },
    ...
    Builder {
       BuilderName = 'SorianEdit Air CDR Assist Factory Upgrade Tech 3',
       PlatoonTemplate = 'CommanderAssistSorianEdit',
       Priority = 6000,
       BuilderConditions = {
			{ EBC, 'GreaterThanEconStorageRatio', { 0.4, 0.9 } },
...
BuilderGroup {
    BuilderGroupName = 'SorianEditNavyACUBuilders',
    BuildersType = 'EngineerBuilder',
	
    Builder {
        BuilderName = 'SorianEdit Navy CDR T1 Power - Init',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 4100000,
        BuilderConditions = {
			{ UCBC, 'LessThanGameTimeSecondsSE', { 150 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR Base Mex Init',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 4000000,
        BuilderConditions = {
				{ UCBC, 'LessThanGameTimeSecondsSE', { 150 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR T1 Power - Init 2nd',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 2000000,
        BuilderConditions = {
			{ UCBC, 'LessThanGameTimeSecondsSE', { 150 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR Base Mex 2nd',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 1000000,
        BuilderConditions = {
				{ UCBC, 'LessThanGameTimeSecondsSE', { 120 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR Base Mex 2+ After Hydro',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 555000,
        BuilderConditions = {
				{ UCBC, 'LessThanGameTimeSecondsSE', { 140 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR T1 Air - Init 2nd',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 390000,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.23, 0.3 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR T1 Air - Init 2nd aHydro',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 389900,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.22, 0.34 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR T1 Land if Path - Init aHydro',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 380000,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.25, 0.3 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR T1 Land if Path  - Init',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 380000,
        BuilderConditions = {
            { EBC, 'GreaterThanEconStorageRatio', { 0.25, 0.3 } },
    ...
    Builder {
        BuilderName = 'SorianEdit Navy CDR T1 Power - additional',
        PlatoonTemplate = 'CommanderBuilderSorianEdit',
        Priority = 3500,
        BuilderConditions = {
            { EBC, 'LessThanEconStorageRatio', { 1.0, 0.2 } },
    ...
    -- CDR Assisting
    Builder {
        BuilderName = 'SorianEdit Navy CDR Assist Hydrocarbon',
        PlatoonTemplate = 'CommanderAssist',
        Priority = 21000,
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsInCategoryBeingBuiltAtLocationSE', { 'LocationType', 0, categories.STRUCTURE * categories.HYDROCARBON }},
    ...
    -- CDR Assisting
    Builder {
        BuilderName = 'SorianEdit Navy CDR Assist T4',
        PlatoonTemplate = 'CommanderAssistSorianEdit',
        Priority = 750,
        BuilderConditions = {
			{ UCBC, 'LocationEngineersBuildingAssistanceGreater', { 'LocationType', 0, 'EXPERIMENTAL' }},
    ...
    Builder {
       BuilderName = 'SorianEdit Navy CDR Assist Factory Upgrade Tech 2',
       PlatoonTemplate = 'CommanderAssistSorianEdit',
       Priority = 6000,
       BuilderConditions = {
			{ EBC, 'GreaterThanEconStorageRatio', { 0.2, 0.6 } },
    ...
    Builder {
       BuilderName = 'SorianEdit Navy CDR Assist Factory Upgrade Tech 3',
       PlatoonTemplate = 'CommanderAssistSorianEdit',
       Priority = 6000,
       BuilderConditions = {
			{ EBC, 'GreaterThanEconStorageRatio', { 0.4, 0.9 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			{ UCBC, 'GreaterThanGameTimeSecondsSE', { 6*60 }},
            ...
            { MABC, 'MarkerLessThanDistance',  { 'Mass', 128, -3, 0, 0}},
            ...
            { UCBC, 'AdjacencyCheck', { 'LocationType', categories.STRUCTURE * categories.MASSEXTRACTION * (categories.TECH2 + categories.TECH3), 4, 'ueb1106' } },
        },
        BuilderType = 'Any',
        BuilderData = {
            Construction = {
    ...
    Builder {
        ...
        Priority = 800,
        BuilderConditions = {
			{ UCBC, 'GreaterThanGameTimeSecondsSE', { 410 } },
    ...
    Builder {
        ...
        DelayEqualBuildPlatoons = {'CheapEnergyBuilding', 4},
        BuilderConditions = {
			{ UCBC, 'GreaterThanGameTimeSecondsSE', { 2*60 }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			-- { UCBC, 'GreaterThanGameTimeSecondsSE', { 100 } },
    ...
    Builder {
        ...
        DelayEqualBuildPlattons = {'MASSEXTRACTION', 3},
        BuilderConditions = {
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 320 }},
            { MABC, 'CanBuildOnMassLessThanDistance', { 'LocationType', 60, -500, 1000, 0, 'AntiSurface', 1 }}, 
        },
        BuilderType = 'Any',
        BuilderData = {
    ...
    Builder {
        ...
        DelayEqualBuildPlattons = {'MASSEXTRACTION', 3},
        BuilderConditions = {
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 120 }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderType = 'Any',
        BuilderConditions = {
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 180 }},
			{ EBC, 'GreaterThanEconTrend', { 0.5, 0.8 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'EnemyUnitsGreaterAtLocationRadiusSE', { 512, 'LocationType', 0, categories.ALLUNITS - (categories.ENGINEER * categories.TECH1 * categories.TECH2) - categories.AIR - categories.SCOUT }},
        },
        BuilderType = 'Any',
    },
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'GreaterThanGameTimeSecondsSE', { 300 }},
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 4, categories.STRUCTURE * categories.FACTORY * categories.LAND - categories.SUPPORTFACTORY } },
            { UCBC, 'EnemyUnitsGreaterAtLocationRadiusSE', { 86, 'LocationType', 0, categories.ALLUNITS - (categories.ENGINEER * categories.TECH1 * categories.TECH2) - categories.AIR - categories.SCOUT }},
        },
        BuilderType = 'Any',
    },
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'PoolGreaterAtLocation', { 0, categories.SUBCOMMANDER} },
    ...
    Builder {
        ...
        BuilderConditions = {
			{ UCBC, 'PoolGreaterAtLocation', { 3, categories.SUBCOMMANDER} },
        },
        BuilderType = 'Any',
    },
}
