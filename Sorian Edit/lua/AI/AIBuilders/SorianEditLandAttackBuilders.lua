...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            --{ SBC, 'NoRushTimeCheck', { 600 }},
            -- { UCBC, 'PoolLessAtLocation', { 'LocationType', 60, categories.MOBILE * categories.LAND - categories.EXPERIMENTAL - categories.ENGINEER } },
            { UCBC, 'HaveUnitRatio', { 0.20, categories.LAND * categories.MOBILE * (categories.COUNTERINTELLIGENCE + (categories.SHIELD * categories.DEFENSE)) - categories.DIRECTFIRE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1}},
        },
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 600,
        BuilderConditions = {
            { UCBC, 'HaveUnitRatio', { 0.15, categories.LAND * categories.ANTIAIR * categories.MOBILE - categories.TECH1, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1}},
            --{ MIBC, 'CanPathToCurrentEnemy', { true } },
            { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 0, categories.LAND * categories.FACTORY * categories.TECH2 } },
            { UCBC, 'FactoryLessAtLocation', { 'LocationType', 2, 'FACTORY TECH3' }},
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 1200,
        BuilderConditions = {
            { UCBC, 'HaveUnitRatio', { 0.15, categories.LAND * categories.ANTIAIR * categories.MOBILE - categories.TECH1 - categories.TECH2, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1}},
            --{ MIBC, 'CanPathToCurrentEnemy', { true } },
            { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 0, categories.LAND * categories.FACTORY * categories.TECH2 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconStorageRatio', { 0.03, 0.01 } },
