...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 3, categories.LAND * categories.DIRECTFIRE * categories.MOBILE * categories.TECH2 - categories.ENGINEER }},
			{ UCBC, 'CanBuildCategorySE', { categories.LAND * categories.MOBILE * categories.SHIELD * categories.DEFENSE - categories.DIRECTFIRE }},
            { UCBC, 'HaveForEach', { categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1 - categories.COMMAND - categories.COMMAND, 0.35, categories.LAND * categories.MOBILE * (categories.COUNTERINTELLIGENCE + (categories.SHIELD * categories.DEFENSE)) - categories.DIRECTFIRE }},
			{ UCBC, 'PoolLessAtLocation', { 'LocationType', 4, categories.LAND * categories.MOBILE * (categories.COUNTERINTELLIGENCE + (categories.SHIELD * categories.DEFENSE)) - categories.DIRECTFIRE }},
        },
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
				...
				{ SBC, 'CanPathToCurrentEnemy', { true, 'LocationType' } },
                { UCBC, 'PoolGreaterAtLocation', { 'LocationType', 0, categories.MOBILE * categories.LAND - categories.SHIELD - categories.ENGINEER } },
            },
        BuilderData = {
    ...
    Builder {
        ...
        BuilderConditions = {
				...
				{ SBC, 'CanPathToCurrentEnemy', { true, 'LocationType' } },
                { UCBC, 'PoolGreaterAtLocation', { 'LocationType', 4, categories.MOBILE * categories.LAND - categories.SHIELD - categories.ENGINEER } },
            },
        BuilderData = {
            NeverGuardBases = true,
            NeverGuardEngineers = true,
