...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { SBC, 'HaveUnitRatioSorian', { 0.3, categories.LAND * categories.INDIRECTFIRE * categories.MOBILE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1 - categories.COMMAND}},
            -- { MIBC, 'CanPathToCurrentEnemy', { true, 'LocationType' } },
        },
    },
    -- Tech 2 priority
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveForEach', { categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1 - categories.COMMAND, 0.2, categories.LAND * categories.MOBILE * (categories.COUNTERINTELLIGENCE + (categories.SHIELD * categories.DEFENSE)) - categories.DIRECTFIRE }},
			{ UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.ENERGYPRODUCTION * categories.TECH3 - categories.HYDROCARBON } },
            -- { MIBC, 'CanPathToCurrentEnemy', { true, 'LocationType' } },
        },
    },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { SBC, 'HaveUnitRatioSorian', { 0.2, categories.LAND * categories.ANTIAIR * categories.MOBILE - categories.TECH1, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1 - categories.COMMAND}},
            -- { MIBC, 'CanPathToCurrentEnemy', { true, 'LocationType' } },
        },
        BuilderType = 'Land',
    },
