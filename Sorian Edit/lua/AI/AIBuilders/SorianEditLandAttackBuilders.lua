...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 500,
        BuilderConditions = {
            -- { UCBC, 'FactoryLessAtLocation', { 'LocationType', 3, 'FACTORY TECH2' }},
			{ UCBC, 'HaveLessThanUnitsWithCategory', { 2, categories.ENERGYPRODUCTION * categories.TECH3 - categories.HYDROCARBON } },
            --{ MIBC, 'CanPathToCurrentEnemy', { true } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 0, categories.LAND * categories.FACTORY * categories.TECH1 } },
            { UCBC, 'HaveUnitRatio', { 0.25, categories.LAND * categories.ANTIAIR * categories.MOBILE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE}},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            --{ SBC, 'NoRushTimeCheck', { 600 }},
            -- { UCBC, 'PoolLessAtLocation', { 'LocationType', 60, categories.MOBILE * categories.LAND - categories.EXPERIMENTAL - categories.ENGINEER } },
            { UCBC, 'HaveUnitRatio', { 0.45, categories.LAND * categories.INDIRECTFIRE * categories.MOBILE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE}},
			-- { UCBC, 'LessThanGameTimeSeconds', { 730 } },
        },
    },
    -- Tech 2 priority
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            --{ SBC, 'NoRushTimeCheck', { 600 }},
            -- { UCBC, 'PoolLessAtLocation', { 'LocationType', 60, categories.MOBILE * categories.LAND - categories.EXPERIMENTAL - categories.ENGINEER } },
            { UCBC, 'HaveUnitRatio', { 0.3, categories.LAND * categories.MOBILE * (categories.COUNTERINTELLIGENCE + (categories.SHIELD * categories.DEFENSE)) - categories.DIRECTFIRE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1}},
        },
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 1000,
        BuilderConditions = {
            { UCBC, 'HaveUnitRatio', { 0.3, categories.LAND * categories.ANTIAIR * categories.MOBILE - categories.TECH1, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1}},
			{ UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.ENERGYPRODUCTION * categories.TECH3 - categories.HYDROCARBON } },
            --{ MIBC, 'CanPathToCurrentEnemy', { true } },
            { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 0, categories.LAND * categories.FACTORY * categories.TECH2 } },
            { UCBC, 'FactoryLessAtLocation', { 'LocationType', 2, 'FACTORY TECH3' }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            --{ SBC, 'NoRushTimeCheck', { 600 }},
            -- { UCBC, 'PoolLessAtLocation', { 'LocationType', 60, categories.MOBILE * categories.LAND - categories.EXPERIMENTAL - categories.ENGINEER } },
            { UCBC, 'HaveUnitRatio', { 0.3, categories.LAND * categories.ANTIAIR * categories.MOBILE * categories.TECH3, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE * categories.TECH3}},
            -- { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, 'LAND ANTIAIR MOBILE' } },
            -- { UCBC, 'PoolLessAtLocation', { 'LocationType', 60, categories.MOBILE * categories.LAND - categories.EXPERIMENTAL - categories.ENGINEER } },
            --{ TBC, 'HaveLessThreatThanNearby', { 'LocationType', 'AntiAir', 'Air' } },
        },
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 1400,
        BuilderConditions = {
            { UCBC, 'HaveUnitRatio', { 0.3, categories.LAND * categories.ANTIAIR * categories.MOBILE - categories.TECH1 - categories.TECH2, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1 - categories.TECH2}},
            --{ MIBC, 'CanPathToCurrentEnemy', { true } },
            { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 0, categories.LAND * categories.FACTORY * categories.TECH2 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconStorageRatio', { 0.03, 0.01 } },
...
Builder {
    ...
    Builder {
        ...
        BuilderData = {
            ...
            ThreatWeights = {
                PrimaryTargetThreatType = 'Land',
                PrimaryThreatWeight = 6,
                SecondaryTargetThreatType = 'Economy',
                SecondaryThreatWeight = 2,
                WeakAttackThreatWeight = 3,
                StrongAttackThreatWeight = 3,
                IgnoreThreatLessThan = 3,
                IgnoreCommanderStrength = true,
                EnemyThreatRings = 1,
                TargetCurrentEnemy = false,
    ...
    Builder {
        ...
        BuilderData = {
            ...
            ThreatWeights = {
                PrimaryTargetThreatType = 'Land',
                PrimaryThreatWeight = 5,
                SecondaryTargetThreatType = 'Economy',
                SecondaryThreatWeight = 5,
                WeakAttackThreatWeight = 5,
                StrongAttackThreatWeight = 7,
