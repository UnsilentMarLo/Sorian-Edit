...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.60, 0.8 }},
			{ UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.ENERGYPRODUCTION * categories.TECH3 - categories.HYDROCARBON } },
            { SBC, 'HaveUnitRatioSorian', { 0.3, categories.LAND * categories.MOBILE * (categories.COUNTERINTELLIGENCE + (categories.SHIELD * categories.DEFENSE)) - categories.DIRECTFIRE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1}},
        },
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.65, 0.75 }},
            { SBC, 'HaveUnitRatioSorian', { 0.3, categories.LAND * categories.INDIRECTFIRE * categories.MOBILE * categories.BOT * categories.INDIRECTFIRE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - (categories.BOT * categories.INDIRECTFIRE)}},
        },
    },
    Builder {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconStorageRatio', { 0.1, 0.3 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.65, 0.75 }},
            { SBC, 'HaveUnitRatioSorian', { 0.4, categories.LAND * categories.MOBILE * (categories.COUNTERINTELLIGENCE + (categories.SHIELD * categories.DEFENSE)) - categories.DIRECTFIRE, '<=', categories.LAND * categories.DIRECTFIRE * categories.MOBILE - categories.TECH1}},
        },
    },
}
...
BuilderGroup {
    ...
    BuildersType = 'PlatoonFormBuilder',
    Builder {
        BuilderName = 'SorianEdit Frequent Land Attack Default - UseTransport',
        PlatoonTemplate = 'LandAttackPlatoonSorianEdit',
        --PlatoonAddPlans = {'PlatoonCallForHelpAISorian', 'DistressResponseAISorian'},
        PlatoonAddBehaviors = { 'AirLandToggleSorian' },
        Priority = 500,
    ...
    Builder {
        BuilderName = 'SorianEdit Frequent Artillery Attack Default - UseTransport',
        PlatoonTemplate = 'LandAttackSorianEditArty',
        --PlatoonAddPlans = {'PlatoonCallForHelpAISorian', 'DistressResponseAISorian'},
        PlatoonAddBehaviors = { 'AirLandToggleSorian' },
        Priority = 500,
    ...
    Builder {
        BuilderName = 'SorianEdit Frequent Land Attack - Medium - UseTransport',
        PlatoonTemplate = 'LandAttackMediumSorianEdit',
        --PlatoonAddPlans = {'PlatoonCallForHelpAISorian', 'DistressResponseAISorian'},
        PlatoonAddBehaviors = { 'AirLandToggleSorian' },
        Priority = 500,
    ...
    Builder {
        BuilderName = 'SorianEdit Frequent Land Attack - Large - UseTransport',
        PlatoonTemplate = 'LandAttackLargeSorianEdit',
        --PlatoonAddPlans = {'PlatoonCallForHelpAISorian', 'DistressResponseAISorian'},
        PlatoonAddBehaviors = { 'AirLandToggleSorian' },
        Priority = 500,
