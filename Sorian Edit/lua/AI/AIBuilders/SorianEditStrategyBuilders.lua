    ...
    Builder {
        ...
        RemoveBuilders = {
            FactoryManager = {
                ...
                --'SorianEdit T2 Amphibious Tank - Tech 2',
                --'SorianEdit T2 Amphibious Tank - Tech 3',
                --'SorianEdit T2 Amphibious Tank - Tech 2 Cybran',
                --'SorianEdit T2 Amphibious Tank - Tech 3 Cybran',
