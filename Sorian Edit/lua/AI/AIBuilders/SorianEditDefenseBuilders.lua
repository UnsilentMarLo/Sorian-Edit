...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'AdjacencyCheck', { 'LocationType', 'MASSEXTRACTION', 1200, 'ueb2101' } },
        },
        BuilderType = 'Any',
        BuilderData = {
            NeedGuard = true,
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'UnitCapCheckLess', { .8 } },
            { SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.9, 1.2 }},
            { UCBC, 'AdjacencyCheck', { 'LocationType', 'MASSEXTRACTION', 1200, 'ueb2301' } },
        },
        BuilderType = 'Any',
        BuilderData = {
            NeedGuard = true,
...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'SorianEdit T3 Shield D Engineer Factory Adj Cybran',
        PlatoonTemplate = 'T3EngineerBuilderSorianEdit',
        Priority = 950,
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 5, categories.ENGINEER * categories.TECH3}},
