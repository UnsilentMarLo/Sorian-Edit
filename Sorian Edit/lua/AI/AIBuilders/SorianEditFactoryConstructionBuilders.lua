...
BuilderGroup {
    BuilderGroupName = 'SorianEditAirInitialFactoryConstruction',
    BuildersType = 'EngineerBuilder',
    -- =======================================
    --     Land Factory Builders - Initial
    -- =======================================
    Builder {
        ...
        BuilderConditions = {
			{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 2, categories.FACTORY * categories.LAND * categories.TECH1 - categories.COMMAND } },
			{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 2, categories.ENERGYPRODUCTION - categories.HYDROCARBON } },
			{ UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'FACTORY LAND', 'LocationType', }},
			{ UCBC, 'FactoryLessAtLocation', { 'LocationType', 1, 'FACTORY LAND' }},
			{ SBC, 'CanPathToCurrentEnemy', { true, 'LocationType' } },
        },
        BuilderType = 'Any',
        BuilderData = {
    ...
    Builder {
        BuilderName = 'SorianEdit T1 Land Factory Builder - Initial 2nd before Upgrade',
        PlatoonTemplate = 'EngineerBuilderSorianEditTECH1',
        Priority = 5900000,
        BuilderConditions = {
				{ EBC, 'GreaterThanEconIncome',  { 2.8, 28.0}},
                { UCBC, 'HaveLessThanUnitsWithCategory', { 3,  categories.FACTORY * categories.LAND * categories.RESEARCH - categories.TECH1 - categories.COMMAND } },
				{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 2,  categories.MASSEXTRACTION * (categories.TECH2 + categories.TECH3) } },
				{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 2,  categories.FACTORY * categories.LAND * categories.RESEARCH * categories.TECH1 } },
        },
        BuilderType = 'Any',
        BuilderData = {
            Construction = {
