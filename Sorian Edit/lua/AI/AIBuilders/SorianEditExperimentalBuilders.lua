...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 1100,
        DelayEqualBuildPlattons = {'SEExperimental', 10},
        BuilderConditions = {
            -- { UCBC, 'HaveUnitRatioUveso', { 0.2, categories.MOBILE * categories.LAND * categories.EXPERIMENTAL, '>=', categories.MOBILE * categories.LAND * categories.TECH3 }},
	...
	-- EXP in ratio to T3 Land, this will keep a good mix of T4 and if the economy cant support it well just make space for it
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'CheckBuildPlattonDelay', { 'SEExperimental' }},
            -- { UCBC, 'HaveUnitRatioUveso', { 0.2, categories.MOBILE * categories.AIR * categories.EXPERIMENTAL, '>=', categories.MOBILE * categories.LAND * categories.TECH3 }},
        },
        BuilderType = 'Any',
        BuilderData = {
            MinNumAssistees = 3,
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.82, 1.1 }},
            -- { IBC, 'BrainNotLowMassMode', {} },
            -- { IBC, 'BrainNotLowPowerMode', {} },
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 2, 'MOBILE LAND EXPERIMENTAL' }},
        },
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconStorageRatio', { 0.4, 0.9 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.84, 1.2 }},
            -- { IBC, 'BrainNotLowMassMode', {} },
            -- { IBC, 'BrainNotLowPowerMode', {} },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderData = {
            ...
            IgnorePathing = true,
            TargetSearchCategory = categories.MOBILE * categories.LAND - categories.TECH1 - categories.ANTIAIR - categories.SCOUT,
            MoveToCategories = {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderData = {
            ...
            AttackEnemyStrength = 120000,
            IgnorePathing = true,
            TargetSearchCategory = categories.ALLUNITS - categories.SCOUT - categories.TECH1,
            MoveToCategories = {
                categories.STRUCTURE * categories.EXPERIMENTAL * categories.ECONOMIC,
                categories.STRUCTURE * categories.EXPERIMENTAL,
                categories.STRUCTURE * categories.NUKE,
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderData = {
            ...
            AttackEnemyStrength = 120000,
            IgnorePathing = true,
            TargetSearchCategory = categories.MOBILE * categories.LAND - categories.TECH1,
            MoveToCategories = {
                categories.STRUCTURE * categories.EXPERIMENTAL * categories.ECONOMIC,
