...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanMassStorageCurrent', { 450 }}, -- { EBC, 'GreaterThanEconStorageRatio', { 0.2, 0.8 } },
			{ EBC, 'GreaterThanEconTrend', { 0.3, 0.6 } },
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'CheckBuildPlatoonDelay', { 'SEExperimental' }},
            { EBC, 'GreaterThanMassStorageCurrent', { 450 }}, -- { EBC, 'GreaterThanEconStorageRatio', { 0.3, 0.8 } },
			{ EBC, 'GreaterThanEconTrend', { 0.3, 0.6 } },
			{ EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.2} },
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.EXPERIMENTAL}},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, categories.NUKE * categories.STRUCTURE}},
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'CheckBuildPlatoonDelay', { 'SEExperimental' }},
            { EBC, 'GreaterThanMassStorageCurrent', { 450 }}, -- { EBC, 'GreaterThanEconStorageRatio', { 0.4, 0.8 } },
			{ EBC, 'GreaterThanEconTrend', { 0.3, 0.6 } },
			{ EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.1 }}, -- { 0.7, 0.8 }},
...
BuilderGroup {
    ...
    Builder {
        ...
        InstanceCount = 1,
        BuilderConditions = {
            { EBC, 'GreaterThanMassStorageCurrent', { 450 }}, -- { EBC, 'GreaterThanEconStorageRatio', { 0.1, 0.8 } },
			{ EBC, 'GreaterThanEconTrend', { 0.3, 0.6 } },
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'CheckBuildPlatoonDelay', { 'SEExperimental' }},
            { EBC, 'GreaterThanMassStorageCurrent', { 450 }}, -- { EBC, 'GreaterThanEconStorageRatio', { 0.5, 0.8 } },
			{ EBC, 'GreaterThanEconTrend', { 0.3, 0.6 } },
			{ EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.1 }}, -- { 0.7, 0.8 }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderType = 'Any',
        BuilderConditions = {
            { UCBC, 'PoolGreaterAtLocation', { 'LocationType', 0, categories.MOBILE * categories.LAND * categories.ARTILLERY * categories.EXPERIMENTAL } },
        },
        BuilderData = {
            SearchRadius = 100000,
            GetTargetsFromBase = false,
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'CheckBuildPlatoonDelay', { 'SEExperimental' }},
			{ EBC, 'GreaterThanEconTrend', { 0.3, 0.6 } },
			{ EBC, 'GreaterThanEconEfficiencyCombined', { 0.9, 1.2 }}, -- { 0.7, 0.8 }},
