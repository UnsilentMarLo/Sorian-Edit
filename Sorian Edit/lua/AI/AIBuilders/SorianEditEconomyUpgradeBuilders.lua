...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { SIBC, 'GreaterThanEconIncome',  { 3.5, 0.10}},
    ...
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { SIBC, 'GreaterThanEconIncome',  { 2.0, 0.10}},
            --{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 65, 1.2 }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { SIBC, 'GreaterThanEconIncome',  { 2.2, 0.10}},
            --{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 65, 1.2 }},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'MASSEXTRACTION TECH2', 'MASSEXTRACTION TECH3' } },
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 5, 'MASSEXTRACTION TECH1' }},
        },
    ...
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { SIBC, 'GreaterThanEconIncome',  { 6, 0.10}},
            --{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 65, 1.2 }},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'MASSEXTRACTION TECH2', 'MASSEXTRACTION TECH2' } },
    ...
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { SIBC, 'GreaterThanEconIncome',  { 1.5, 0.10}},
            { SIBC, 'GreaterThanEconEfficiencyOverTime', { 65, 1.2 }},
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'MASSEXTRACTION TECH2', 'MASSEXTRACTION TECH2' } },
            { SIBC, 'HaveGreaterThanUnitsWithCategory', { 4, 'MASSEXTRACTION TECH1, MASSEXTRACTION TECH2' }},
        },
        FormRadius = 10000,
        BuilderType = 'Any',
    },
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 1, 'ENERGYPRODUCTION TECH2, ENERGYPRODUCTION TECH3' } },
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'MASSEXTRACTION TECH3', 'MASSEXTRACTION TECH2' } },
            { SIBC, 'GreaterThanEconIncome', { 1.3, 0.50 } },
			{ EBC, 'GreaterThanEconStorageCurrent', { 3000, 0 } },
            { IBC, 'BrainNotLowPowerMode', {} },
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 1, 'ENERGYPRODUCTION TECH2, ENERGYPRODUCTION TECH3' } },
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'MASSEXTRACTION TECH3', 'MASSEXTRACTION TECH2' } },
            { SIBC, 'GreaterThanEconIncome',  { 2.0, 0.50 } },
            { IBC, 'BrainNotLowPowerMode', {} },
			{ EBC, 'GreaterThanEconStorageCurrent', { 3000, 0 } },
            --{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.90, 1.2 }},
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 2, 'MASSEXTRACTION TECH2, MASSEXTRACTION TECH3' }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
				...
				{ SIBC, 'GreaterThanEconIncome',  { 10, 50 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { SIBC, 'GreaterThanEconIncome',  { 0.24, 0.50}},
            },
        BuilderType = 'Any',
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'MASSEXTRACTION TECH2, MASSEXTRACTION TECH3'}},
                { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, 'FACTORY TECH2, FACTORY TECH3' } },
                { SIBC, 'GreaterThanEconIncome',  { 3.4, 50}},
            },
        BuilderType = 'Any',
    },
    Builder {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsWithCategory', { 6, 'FACTORY LAND TECH2, FACTORY LAND TECH3' } },
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'FACTORY LAND TECH2, LAND FACTORY TECH3' } },
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'MASSEXTRACTION TECH2, MASSEXTRACTION TECH3'}},
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'FACTORY NAVAL TECH2, FACTORY NAVAL TECH3' } },
                { SIBC, 'GreaterThanEconIncome',  { 0.5, 7.5}},
            },
        BuilderType = 'Any',
    },
    ...
    Builder {
        ...
        InstanceCount = 4,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'FACTORY LAND TECH3, FACTORY LAND TECH2' } },
    ...
    Builder {
        ...
        FormDebugFunction = nil,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'FACTORY AIR TECH3, FACTORY AIR TECH2' } },
    ...
    Builder {
        ...
        InstanceCount = 4,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'FACTORY NAVAL TECH3, FACTORY NAVAL TECH2' } },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 4, 'MASSEXTRACTION TECH2, MASSEXTRACTION TECH3'}},
...
BuilderGroup {
    ...
    Builder {
        ...
        InstanceCount = 4,
        BuilderConditions = {
                { UCBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 4, 'FACTORY LAND TECH3' } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, 'FACTORY TECH2, FACTORY TECH3' } },
                { SIBC, 'GreaterThanEconIncome',  { 6, 5.0}},
    ...
    Builder {
        ...
        BuilderConditions = {
               ...
               -- { UCBC, 'FactoryGreaterAtLocation', { 'LocationType', 1, 'NAVAL FACTORY' } },
                { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, 'FACTORY TECH3, FACTORY TECH2' } },
                { SIBC, 'GreaterThanEconIncome',  { 6, 6.0}},
                { IBC, 'BrainNotLowPowerMode', {} },
                --{ SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.75, 1.2} },
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'FACTORY TECH3, FACTORY TECH2'}},
                --{ UCBC, 'FactoryLessAtLocation', { 'MAIN', 1, 'FACTORY TECH1' } },
