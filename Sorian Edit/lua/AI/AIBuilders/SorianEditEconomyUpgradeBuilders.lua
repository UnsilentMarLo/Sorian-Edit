...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'HaveLessThanUnitsInCategoryBeingUpgrade', { 1, categories.FACTORY * categories.LAND * categories.RESEARCH * categories.TECH2 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'HaveLessThanUnitsWithCategory', { 1, 'FACTORY NAVAL TECH2 RESEARCH, FACTORY NAVAL TECH3 RESEARCH'}},
                --{ UCBC, 'HaveGreaterThanUnitsWithCategory', { 4, 'MASSEXTRACTION TECH2'}},
				{ UCBC, 'GreaterThanGameTimeSeconds', { 300 } },
                { EBC, 'GreaterThanEconIncome',  { 35, 75}},
                { IBC, 'BrainNotLowPowerMode', {} },
