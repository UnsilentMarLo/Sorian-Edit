...
BuilderGroup {
	...
	BuilderName = 'SorianEditT1 Air Bomber Initial',
        ...
        BuilderConditions = {
			...
			{ UCBC, 'LessThanGameTimeSecondsSE', { 380 } },
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ UCBC, 'LessThanGameTimeSecondsSE', { 240 } },
    ...
    Builder {
        ...
        Priority = 4500,
        BuilderConditions = {
			{ UCBC, 'LessThanGameTimeSecondsSE', { 480 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.65, 0.8 }},
			{ UCBC, 'HaveLessThanUnitsWithCategory', { 1, 'BOMBER TECH3' }},
        },
    },
    Builder {
        BuilderName = 'SorianEditT3 Air Bomber',
...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 22000,
        BuilderConditions = {
            { UCBC, 'LessThanGameTimeSecondsSE', { 300 } },
            { EBC, 'GreaterThanEconStorageRatio', { 0.08, 0.3 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.7, 1.0 }},
...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'SorianEditAntiAirBaseGuardT3',
        PlatoonTemplate = 'AntiAirBaseGuardSorianEdit',
        -- PlatoonAddBehaviors = { 'AirUnitRefitSorian' },
        --PlatoonAddPlans = { 'AirIntelToggle' },
        Priority = 200,
        ...
        BuilderConditions = {
            { UCBC, 'HaveUnitsWithCategoryAndAlliance', { true, 1, categories.AIR * categories.MOBILE * categories.ANTIAIR, 'Enemy'}},
            { UCBC, 'PoolGreaterAtLocation', { 'LocationType', 1, categories.AIR * categories.MOBILE * categories.ANTIAIR * categories.TECH3 - categories.BOMBER - categories.TRANSPORTFOCUS - categories.EXPERIMENTAL } },
            -- { SBC, 'NoRushTimeCheck', { 0 }},
        },
    },
}
