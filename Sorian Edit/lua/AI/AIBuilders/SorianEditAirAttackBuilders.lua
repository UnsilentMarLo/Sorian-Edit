...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderType = 'Air',
        BuilderConditions = {
            { UCBC, 'HaveUnitRatioUveso', { 0.35, categories.AIR * categories.GROUNDATTACK * categories.MOBILE, '<=', categories.AIR * categories.ANTIAIR * categories.MOBILE}},
            -- { IBC, 'BrainNotLowMassMode', {} },
            -- { IBC, 'BrainNotLowPowerMode', {} },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconStorageRatio', { 0.04, 0.01 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderType = 'Air',
        BuilderConditions = {
            { UCBC, 'HaveUnitRatioUveso', { 0.35, categories.AIR * categories.GROUNDATTACK * categories.MOBILE * categories.TECH3 , '<=', categories.AIR * categories.ANTIAIR * categories.MOBILE * categories.TECH3 }},
            -- { IBC, 'BrainNotLowMassMode', {} },
            -- { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconStorageRatio', { 0.04, 0.01 } },
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
    ...
    Builder {
        ...
        BuilderType = 'Air',
        BuilderConditions = {
            { UCBC, 'HaveUnitRatioUveso', { 0.3, categories.BOMBER * categories.AIR * categories.TECH3, '<=', categories.ANTIAIR * categories.AIR * categories.TECH3}},
            -- { IBC, 'BrainNotLowMassMode', {} },
            -- { IBC, 'BrainNotLowPowerMode', {} },
            { UCBC, 'UnitCapCheckLess', { 0.95 } },
            { EBC, 'GreaterThanEconStorageRatio', { 0.04, 0.01 } },
    ...
    Builder {
        ...
        BuilderData = {
            ...
            PrioritizedCategories = {
                ...
                'EXPERIMENTAL ORBITALSYSTEM',
                'STRUCTURE STRATEGIC TECH3',
                'ENERGYPRODUCTION TECH3 DRAGBUILD',
                'COMMAND',
                'MASSEXTRACTION',
                'MOBILE LAND ANTIAIR TECH3',
                'MOBILE LAND TECH3',
                'ENGINEER',
                'MASSFABRICATION',
                'SHIELD',
