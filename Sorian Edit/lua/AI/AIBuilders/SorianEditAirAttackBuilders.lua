...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
			{ EBC, 'GreaterThanEconStorageRatio', { 0.08, 0.3 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.3, 0.4 }},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            -- { SBC, 'IsWaterMap', { true } },
            { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, categories.TRANSPORTFOCUS } },
            { UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.TRANSPORTFOCUS * categories.AIR * categories.TECH2 } },
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.MOBILE * categories.AIR * categories.ANTIAIR} },
    ...
    Builder {
        ...
        BuilderConditions = {
            { MIBC, 'ArmyNeedsTransports', {} },
            -- { SBC, 'IsWaterMap', { true } },
			{ UCBC, 'CanBuildCategory', { categories.TRANSPORTFOCUS * categories.AIR * categories.TECH3 } },
            { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, categories.TRANSPORTFOCUS } },
            { UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.TRANSPORTFOCUS * categories.AIR * categories.TECH3 } },
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
			...
			{ EBC, 'GreaterThanEconStorageRatio', { 0.08, 0.3 } },
			{ EBC, 'GreaterThanEconEfficiencyOverTime', { 0.7, 1.0 }},
            { UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.TRANSPORTFOCUS * categories.AIR - categories.TECH1 } },
            { MIBC, 'ArmyNeedsTransports', {} },
            { UCBC, 'LocationFactoriesBuildingLess', { 'LocationType', 1, 'TRANSPORTFOCUS' } },
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 0, categories.MOBILE * categories.AIR * categories.ANTIAIR} },
